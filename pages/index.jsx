    ...
    <>
      <div className="content">
        ...
        <div className="disclaimer">
          Trading is risky! ZebraSwap is not responsible for any trading losses
          or financial losses while using the app. DYOR before buying any token
          or making any trade to avoid getting rekt. ZebraSwap is beta software
          and may contain bugs. Bug reports in the ZebraSwap Discord server are
          appreciated!
        </div>
      </div>
      <style jsx>{`
